...
//        btnGoogle = findViewById(R.id.btn_google);
        ...
        final LinearLayout addSiteTouristiqueLayout;
        ...
        addSiteTouristiqueTxt = findViewById(R.id.addSiteTouristiqueTxt);
...
//
            maps.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(MainActivity.this, NearbyPlacesOfCurrentLocation.class );
                    startActivity(intent);
        ...
        homeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(selectedTab != 1){
                    ...
                    addSiteTouristiqueTxt.setVisibility(View.GONE);
                    ...
                    addSiteTouristiqueImage.setImageResource(R.drawable.baseline_add_box_24);
                    ...
                    addSiteTouristiqueLayout.setBackgroundColor(getResources().getColor(android.R.color.transparent));
        ...
        addSiteTouristiqueLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if(selectedTab != 2){
                    ...
                    Intent intent = new Intent(MainActivity.this,addTouristPlace.class);
                    startActivity(intent);
                    ...
                    // select event tab
                    addSiteTouristiqueTxt.setVisibility(View.VISIBLE);
                    addSiteTouristiqueImage.setImageResource(R.drawable.baseline_add_box_24);
                    addSiteTouristiqueLayout.setBackgroundResource(R.drawable.round_back_profile);

                    // create animation
                    ScaleAnimation scaleAnimation = new ScaleAnimation(0.8f, 1.0f, 1f, 1f, Animation.RELATIVE_TO_SELF, 1.0f, Animation.RELATIVE_TO_SELF, 0.0f);
                    scaleAnimation.setDuration(200);
                    scaleAnimation.setFillAfter(true);
                    addSiteTouristiqueLayout.startAnimation(scaleAnimation);
